...
export const SELL_SOURCE_FILTER_BY_CHAIN_ID: Record<ChainId, SourceFilters> = {
    ...
    [ChainId.Base]: new SourceFilters([
...
export const DEFAULT_TOKEN_ADJACENCY_GRAPH_BY_CHAIN_ID: Record<ChainId, TokenAdjacencyGraph> = {
    ...
    [ChainId.Optimism]: new TokenAdjacencyGraphBuilder(DEFAULT_INTERMEDIATE_TOKENS_BY_CHAIN_ID[ChainId.Optimism])
        ...
        .build(),
    [ChainId.Base]: new TokenAdjacencyGraphBuilder(DEFAULT_INTERMEDIATE_TOKENS_BY_CHAIN_ID[ChainId.Base]).build(),
    // Testnets:
...
export const BASESWAP_ROUTER_BY_CHAIN_ID = valueByChainId<string>(
    {
...
export const ROCKETSWAP_ROUTER_BY_CHAIN_ID = valueByChainId<string>(
    {
        [ChainId.Base]: '0x4cf76043b3f97ba06917cbd90f9e3a2aac1b306e',
    },
    NULL_ADDRESS,
);
